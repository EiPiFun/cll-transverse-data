...
y1 = numpy.array((309,293,342))*0.001
y2 = numpy.array((328,324,298))*0.001
y3 = numpy.array((365,330,351))*0.001
y4 = numpy.array((447,368,379))*0.001

y5 = numpy.array((490,433,459))*0.001
