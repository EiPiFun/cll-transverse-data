...
y1 = numpy.array(( 42, 18, 17))*0.001
y2 = numpy.array(( 21, 16, 30))*0.001
y3 = numpy.array((508,224,132))*0.001
y4 = numpy.array(( 42, 19, 32))*0.001

y5 = numpy.array((321,251,182))*0.001
