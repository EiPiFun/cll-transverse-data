...
chart_title = ''
chart_xlabel = 'Unit block length'
...
y1 = numpy.array((132, 91, 77))*0.001
y2 = numpy.array((140,133,159))*0.001
y3 = numpy.array((538,571,559))*0.001
y4 = numpy.array((584,487,418))*0.001

y5 = numpy.array((586,466,590))*0.001
...
plt.savefig(current_path+"strength.png")
