...
$python_name plot_and_save_the_smoothed_delta_to_minimal_hbond.py strain_y_stretch.xvg.txt hbnum_stretch.xvg.txt "" "Strain" "delta Hydrogen Bond Number" "1.0" "1.0" $plot_color $image_file_extension

$python_name plot_and_save_the_smoothed_delta_to_minimal_energy.py strain_y_stretch.xvg.txt stretch-energy-coul-sr.xvg.txt "" "Strain" "delta Coul-SR (kJ/mol)" "1.0" "1.0" $plot_color $image_file_extension
$python_name plot_and_save_the_smoothed_delta_to_minimal_energy.py strain_y_stretch.xvg.txt stretch-energy-lj-sr.xvg.txt "" "Strain" "delta LJ-SR (kJ/mol)" "1.0" "1.0" $plot_color $image_file_extension

$python_name plot_angle.py strain_y_stretch.xvg.txt stretch_direction_angle.txt "" "Strain" "Direction angle" "1.0" "1.0" $plot_color $image_file_extension
